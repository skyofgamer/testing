    ...
    $(".time-countdown").each(function () {
      ...
      $this.countdown(finalDate, function (event) {
        var $this = $(this).html(
          event.strftime(
            "" +
              '<div class="counter-column"><span class="count">%D</span><span class="title">Days</span></div> ' +
              '<div class="counter-column"><span class="count">%H</span><span class="title">Hours</span></div>  ' +
              '<div class="counter-column"><span class="count">%M</span><span class="title">Minutes</span></div>  ' +
              '<div class="counter-column"><span class="count">%S</span><span class="title">Seconds</span></div>'
          )
        );
      });
    });
...
})(window.jQuery); // Wait for the document to be fully loaded


// =========================================================================
       // Function to check screen width and add <br> tags if within the specified range
       function addBrTags() {
        const screenWidth = window.innerWidth;
        const minScreenWidth = 480;
        const maxScreenWidth = 530;

        if (screenWidth >= minScreenWidth && screenWidth <= maxScreenWidth) {
            const Brtag = "<br> <br> <br>";
            const Brtag1 = "<br> <br> <br> <br> <br>";
            document.getElementById("brs").innerHTML = Brtag;
            document.getElementById("brs1").innerHTML = Brtag1;
        } else {
            // Clear the content if screen width is outside the range
            document.getElementById("brs").innerHTML = "";
            document.getElementById("brs1").innerHTML = "";
        }
    }

    // Call the function on page load and window resize
    window.onload = addBrTags;
    window.addEventListener("resize", addBrTags);
    
		//========================================================================
		 // Function to check screen width and add two <br> tags if within the specified range
